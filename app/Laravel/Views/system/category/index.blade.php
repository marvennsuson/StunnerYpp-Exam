...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item "><a href="{{ route('system.category.create') }}" class=" text-info">Create New Category</a></li>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table-hover table">
                        <thead>
                            <tr>
                                <th class=" font-weight-bold">Category title</th>
                        ...
                        <tbody>
                            @forelse ($record as $category)
                            <tr>
                                <td class="align-middle">{{ $category->title  ? Str::title($category->title) : ''}}</td>
                                ...
                                <td class="align-middle"> {{$category->created_at ? $category->created_at->format("F d Y") : '---'}}</td>
                                <td class="align-middle">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{route('system.category.edit',['id' => $category->id ? $category->id : ''])}}" class="dropdown-item">Edit</a>
                                            <button class="dropdown-item" data-toggle="modal" data-target="#delete-confirmation-modal"
                                            data-action="{{ route('system.category.delete',['id' => $category->id ? $category->id : '']) }}">
                                            Delete
                                        </button>
                                        </div>
                                    </div>
